...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("this is from add in UserModel");
		Connection conn = null;
		int pk = 0;
		...
		if (existbean == null) {
			...
			try {
				...
				System.out.println("password type by user is " + bean.getPassword());
	 ...
	 * @throws DatabaseException
	 */
	/* Update the user Details by MyProfilectl */
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				System.out.println("this is from serch List is : " + list);
			}
			rs.close();
		} catch (Exception e) {
	 ...
	 * 
	 * 
	 * Authenticate the user Details id and password
	 */
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		...
		try {
			...
			log.error("Eseption in authentication" + e);
	...
	public long registerUser(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		log.debug("Model add Started");
		System.out.println("Model registerUser Started");
		long pk = add(bean);
		...
		System.out.println("this is from registerUser pk=== " + pk);
		return pk;
	}
